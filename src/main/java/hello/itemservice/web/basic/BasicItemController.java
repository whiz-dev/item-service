...
//    @PostMapping("/add")
    public String addItemV3(@ModelAttribute Item item) {
        ...
        // ModelAttribute name 속성 생략 시 클래스 명의 첫글자를 소문자로 바꾼 이름으로 addAttribute
//        Item item = new Item(itemName, price, quantity);
        itemRepository.save(item);
...
//    @PostMapping("/add")
    ...
    public String addItemV6(Item item, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addAttribute("status", true); //redirect url에 포함되지 않은 항목은 query parameter로 넘어간다.
